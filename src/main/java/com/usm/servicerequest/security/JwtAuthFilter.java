...
/**
 * Reads `Authorization: Bearer <token>`, validates it against the placeholder
 * dev key, and - if valid - puts an AuthContext on the SecurityContext as the
 * authentication principal with a single ROLE_<role> authority.
 *
 ...
 * (/actuator/health, swagger, the dev token endpoint).
 */
